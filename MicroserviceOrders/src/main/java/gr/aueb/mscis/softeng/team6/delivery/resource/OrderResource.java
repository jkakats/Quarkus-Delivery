...
public class OrderResource {
  ...
  @Inject @RestClient ProductService productService;
  ...
  @Counted(
      name = "countAllOrders",
      description = "Count how many times AllOrders service has been invoked")
  ...
  @Operation(
      ...
      description = "User gives the uuid of an order and operation return the corresponding order.")
  public Response read(@PathParam("uuid") UUID uuid) throws NoSuchElementException {
    ...
    if (productsdto.size() > 0) {
      for (OrderProductDto prodDto : orderDto.products()) {
        fullproducts.add(
            new FullOrderProductDto(
                productsdto.get(i), prodDto.price(), prodDto.quantity(), prodDto.review()));
        i++;
      }
    }
    FullOrderDto full =
        new FullOrderDto(
            ...
            orderDto.confirmed(),
            orderDto.delivered(),
            orderDto.orderedTime(),
            orderDto.deliveredTime(),
            orderDto.estimatedWait(),
            orderDto.review(),
            clientdto,
            orderDto.store_id(),
            fullproducts);
  ...
  @Counted(
      name = "countCreateOrder",
      description = "Count how many times CreateOrder service has been invoked")
  ...
  @Counted(
      name = "countUpdateOrder",
      description = "Count how many times UpdateOrder service has been invoked")
  ...
  @Operation(
      ...
      description =
          "Given the uuid of an order and its new information operation updates " + "order.")
  ...
  @RolesAllowed({"admin", "manager"})
  @Counted(
      name = "countDeleteOrder",
      description = "Count how many times DeleteOrder service has been invoked")
  ...
  @Counted(
      ...
      description = "Count how many times ConfirmOrder service has been invoked")
  @Timed(
      name = "timeConfirmOrder",
      description = "How long it takes to invoke ConfirmOrder service")
  ...
  @RolesAllowed({"admin", "manager"})
  @Counted(
      name = "countDeliveredOrder",
      description = "Count how many times DeliveredOrder service has been invoked")
  @Timed(
      name = "timeDeliveredOrder",
      description = "How long it takes to invoke DeliveredOrder service")
  @APIResponse(responseCode = "202", description = "Accepted")
  @Operation(
  ...
  @RolesAllowed({"admin", "client"})
  @Counted(
      name = "countReviewOrder",
      description = "Count how many times ReviewOrder service has been invoked")
  ...
  @Counted(
      ...
      description = "Count how many times StoreOrders service has been invoked")
  ...
  @Counted(
      name = "countGetOrderFallback",
      description = "Count how many times GetOrderFallback service has been invoked")
  @Timed(
      name = "timeGetOrderFallback",
      description = "How long it takes to invoke GetOrderFallback service")
  ...
  @Counted(
      name = "countPostOrderFallback",
      description = "Count how many times PostOrderFallback service has been invoked")
  @Timed(
      name = "timePostOrderFallback",
      description = "How long it takes to invoke PostOrderFallback service")
