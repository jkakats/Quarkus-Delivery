...
public class ClientStatisticsResourceTest {
  ...
  @BeforeEach
  public void setup2(){
    Mockito.when(orderService.getTopClientsOfAStoreForAPeriod(4L, LocalDateTime.of (2022, 12, 7, 0, 0), LocalDateTime.of (2022, 12, 11, 0, 0), 3)).
      thenReturn(List.of(UUID.fromString("4948b178-f325-4f5f-b8ea-0b4d60cd006c"), UUID.fromString("4948b178-f325-4f5f-b8ea-0b4d60cd006c"), UUID.fromString("4948b178-f325-4f5f-b8ea-0b4d60cd006c")));
  }
